...
export default function ProductCard({ p }) {
  return (
    <div className="bg-white rounded-lg p-3.5 text-left transition-all duration-200 ease-in-out hover:-translate-y-1.5 hover:shadow-xl relative w-full h-full flex flex-col">

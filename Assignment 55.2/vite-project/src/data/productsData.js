...
export const products = [
  {
    // Unique ID - helps React identify each product
    id: 1,

    // Product information that will be displayed
  ...
  },
  {
    ...
    category: "Tshirts",
    price: "$20.00",
    oldPrice: "$34.00", // Old price shows this is on sale
    ...
    sale: true, // This flag shows "Sale" badge on the card
  },
  {
    id: 6,
